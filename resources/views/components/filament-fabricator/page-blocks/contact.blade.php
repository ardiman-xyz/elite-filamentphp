@aware(['page'])
@props(['heading', 'subtitle', 'description', 'address', 'country', 'phone_number', 'email'])

<section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] px-4 md:px-0">
                ...
                {{ $heading }}
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color">{{ $phone_number }}</p>
                        </div>
                    </div>
